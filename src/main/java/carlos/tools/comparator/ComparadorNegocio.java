...
public class ComparadorNegocio {

	static List<CocheIncremental> generarIncrementalNegocio(List<Coche> listaInicial, List<Coche> listaNueva) {
	...
	static private List<CocheIncremental> generarAltasYModificaciones(List<Coche> listaInicial, List<Coche> listaNueva) {
	...
	static private List<CocheIncremental> generarBajas(List<Coche> listaInicial, List<Coche> listaNueva) {
